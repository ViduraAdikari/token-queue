...
import {SAMPLE_TOKEN} from "../../../../const/sampleData";

import {createGuest} from '../../../../store/helper/tokenQueueHelper';
import {AVAILABLE_SERVICES} from "../../../../const/services";
...
const GetAToken: React.FC = () => {
  ...
  const serviceID: string = newTokenServiceID ? newTokenServiceID : SAMPLE_TOKEN.serviceID;
  ...
  const displayToken: IDisplayToken = {
    ...SAMPLE_TOKEN, customer: guest, appointmentFor: appointmentFor,
